<template>
  <Head>
    ...
    <meta name="description" content="Create your JobHub account" />
  </Head>
      ...
      <Card class="bg-white shadow-xl border-0">
        ...
        <form @submit.prevent="submit">
          <CardContent class="space-y-4 pt-6">
            <!-- Name Field -->
            <div class="space-y-2">
              <Label for="name" class="text-slate-700 font-medium">
                Full Name
              </Label>
              <div class="relative">
            ...
            <div class="space-y-2">
              <Label for="confirmPassword" class="text-slate-700 font-medium">
                Confirm Password
              </Label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <p v-if="form.errors?.confirmPassword" class="text-sm text-red-600 mt-1">
                {{ Array.isArray(form.errors.confirmPassword) ? form.errors.confirmPassword[0] : form.errors.confirmPassword }}
              </p>
            </div>
            ...
            <div class="flex items-start">
              <input
                ...
                class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-slate-300 rounded mt-1"
                required
              />
              <Label for="terms" class="ml-2 block text-sm text-slate-700">
                I agree to the
                <Link href="/terms" class="text-primary-600 hover:text-primary-700">
                  Terms of Service
                </Link>
                and
                <Link href="/privacy" class="text-primary-600 hover:text-primary-700">
                  Privacy Policy
                </Link>
              </Label>
            </div>
      ...
      <div class="mt-6">
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-slate-50 text-slate-500">Or sign up with</span>
          </div>
        </div>
